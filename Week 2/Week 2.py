...
def PrintAndTraceBackpropagateHiddenToInput(alpha, eta, inputDataList, errorList,
    ...
    print('  deltaWWt00 = ', ' %.2f' % eta, '* %.4f' % error0, ' * %.4f' % transFuncDerivHidden0,
          '  * %.4f' % inputNode0, '  * %.4f' % sumTermH0)
    print('  deltaWWt01 = ', ' %.2f' % eta, '* %.4f' % error1, ' * %.4f' % transFuncDerivHidden1,
          '  * %.4f' % inputNode0, '  * %.4f' % sumTermH1)
    print('  deltaWWt10 = ', ' %.2f' % eta, '* %.4f' % error0, ' * %.4f' % transFuncDerivHidden0,
          '  * %.4f' % inputNode1, '  * %.4f' % sumTermH0)
    print('  deltaWWt11 = ', ' %.2f' % eta, '* %.4f' % error1, ' * %.4f' % transFuncDerivHidden1,
          '  * %.4f' % inputNode1, '  * %.4f' % sumTermH1)
    print(' ')
